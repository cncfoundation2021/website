...
function updateLogoSource(htmlContent) {
    // Replace old logo sources with new PNG image
    const oldLogoPattern = /src="Assets\/WhatsApp Image 2025-09-16 at 11\.19\.21 AM\.jpeg"/g;
    const newLogoSource = 'src="Assets/1000126838.png"';
...
// Main execution
console.log('Starting logo source update to PNG...');
